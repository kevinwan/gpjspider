...
class IncrsohuGPJSpider(IncrGPJSpider):
    name = 'sohu'

class FullsohuGPJSpider(FullGPJSpider):
    name = 'sohu_full'
...
class Fullcn2cheGPJSpider(FullGPJSpider):
    name = 'cn2che_full'

class IncrrenrencheGPJSpider(IncrGPJSpider):
    name = 'renrenche'
...
class FullsoucheGPJSpider(FullGPJSpider):
    name = 'souche_full'
...
class FulltaocheGPJSpider(FullGPJSpider):
    name = 'taoche_full'

class IncrchemaoGPJSpider(IncrGPJSpider):
    name = 'chemao'

class FullchemaoGPJSpider(FullGPJSpider):
    name = 'chemao_full'
...
class IncryoucheGPJSpider(IncrGPJSpider):
    name = 'youche'

class FullyoucheGPJSpider(FullGPJSpider):
    name = 'youche_full'

class IncrutilsGPJSpider(IncrGPJSpider):
    name = 'utils'

class FullutilsGPJSpider(FullGPJSpider):
    name = 'utils_full'

class IncrcheyipaiGPJSpider(IncrGPJSpider):
    name = 'cheyipai'

class FullcheyipaiGPJSpider(FullGPJSpider):
    name = 'cheyipai_full'

class Incrhaoche51GPJSpider(IncrGPJSpider):
    name = 'haoche51'

class Fullhaoche51GPJSpider(FullGPJSpider):
    name = 'haoche51_full'

class IncrxcarGPJSpider(IncrGPJSpider):
    name = 'xcar'

class FullxcarGPJSpider(FullGPJSpider):
    name = 'xcar_full'
...
class Incr58GPJSpider(IncrGPJSpider):
    name = '58'

class Full58GPJSpider(FullGPJSpider):
    name = '58_full'

class Incr99haocheGPJSpider(IncrGPJSpider):
    name = '99haoche'

class Full99haocheGPJSpider(FullGPJSpider):
    name = '99haoche_full'

class IncrbaixingGPJSpider(IncrGPJSpider):
    name = 'baixing'
...
class FullygcheGPJSpider(FullGPJSpider):
    name = 'ygche_full'
